...
{
	std::pair<int, std::string>(1, "Парковка в неположеном месте"),
	std::pair<int, std::string>(2, "Непристегнутый ремень безопасноти"),
...
public:
	...
	tm get_time_from_string(char* str)
	{
		...
		this->time.tm_mday = std::atoi(dateparts[1]) - 1;
